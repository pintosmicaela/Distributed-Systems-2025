    ...
    def SendNews(self, request, context):
        ...
        try:
            ...
            if err.errno == errorcode.ER_ACCESS_DENIED_ERROR:
                ...
                return enviarnoticia_pb2.Response(response="Something is wrong with your user name or password.")
            elif err.errno == errorcode.ER_BAD_DB_ERROR:
                logger.info("Database does not exist")
                return enviarnoticia_pb2.Response(response="Database does not exist.")
            else:
                logger.info(err)
                return enviarnoticia_pb2.Response(response="Err.")
